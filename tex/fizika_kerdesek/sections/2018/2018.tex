    ...
    \subsection{2018.01.03. - Vizsga}
        ...
        \sloppy{
            \begin{enumerate}
                ...
                \item A röptében szétrobbanó tüzijáték darabkái alátal alkotott tömegpontrendszer \underline{\textbf{tömegközéppontja}} egy ferde hajítás pályáján mozog.
                ...
                \item Ugyanazon lejtő tetejéről kezdősebesség nélkül gurítunk le egy tömör hengert, valamint egy ugyanakkora tömegű és sugarú csődarabot. A \underline{\textbf{tömör henger}} ér le hamarabb a lejtő aljára.
                \item Kepler II. törvénye értelmében a napból a bolygóhoz húzott sugár \underline{\textbf{egyenlő időközönként egyenlő területeket súrol}}.
    ...
    \subsection{2018.01.10. - Vizsga}
        ...
        \sloppy{
            \begin{enumerate}
                ...
                \item Newton törvényei értelmezhetők gyorsuló vonatkoztatási rendszerekben is, ha bevezetjük a \underline{\textbf{tehetetlenségi erőket}}.
                ...
                \item Matematikai inga hosszát megduplázzuk. A lengési \underline{\textbf{$\sqrt{2}$-esére}} változik.
                ...
                \item Egy ideális gáz adiabatikus tágulása \underline{\textbf{alacsonyabb}} véghőmérsékletet eredményez, mint ha ugyanazon gázt izoterm folyamat során tágítjuk ugyanakkora térfogatúra.
    ...
    \subsection{2018.11.20. - Pót Nagy ZH}
        ...
        \sloppy{
            \begin{enumerate}
                ...
                \item Egy repülőgép vízszintes pályán közelít a déli sark felé. A Coriolis-erő a pilóta \underline{\textbf{bal}} kezének irányába mutat.
                ...
                \item Egy $3m$ és egy $m$ tömegű gyurmagolyót helyezünk el egymástól adott távolságra. A nagyobbik golyóból lecsípünk $m$ tömeget, és hozzágyúrjuk a kissebbik golyóhoz. A két golyó közti gravitációs kölcsönhatás mértéke \underline{\textbf{nő}}.
    ...
    \subsection{2018.12.13. - Pót Pót Nagy ZH}
        ...
        \sloppy{
            \begin{enumerate}
                ...
                \item A ferde hajítás felbontható egy függőleges irányú \underline{\textbf{egyenletesen változó}} valamint egy vízszintes irányú \underline{\textbf{egyenletes}} mozgásra. 
                ...
                \item Egy elütött jégkorong lassulásának nagysága $0,5 m/s^2$. A jég és a korong közöti csúszási súrlódási együttható értéke közelítőleg: \underline{\textbf{$ 0,05 \;\;\;\; F_s=ma \;\;\;\; a=g\mu \;\;\;\; mg\mu = ma  \;\;\;\; \mu=\frac{a}{g}$}}.
                \item A Föld déli féltekén  északi irányban közlekedő vonatokra \underline{\textbf{nyugati irányba}} mutató Coriolis-erő hat.
                ...
                \item Egy sportoló $h$ magasságba emel egy $m$ tömegű súlyzót, majd visszateszi oda, ahonnan elvette. A sportoló nehézségi erőtér ellenében végzett munkája \underline{\textbf{nulla}}.
    ...
    \subsection{2018.12.19. - Vizsga}
        ...
        \sloppy{
            \begin{enumerate}
                ...
                \item Rugalmas ütközés előtt a testek mechanikai energiáinak összege mindig \underline{\textbf{ugyanakkora}}, mint ütközés után.
                ...
                \item Tömegpontrendszer \underline{\textbf{impulzusa}} megmarad, ha a tömegpontrendszerre ható külső erők eredője nulla.
                ...
                \item Kepler I. törvénye értelmében a bolygók \underline{\textbf{ellipszispályán keringenek, egyik fókuszpontban a nap áll.}}.
                ...
                \item A pörgettyűk impulzusmomentum-vektorának külső erők hatására bekövetkező irányváltozását \underline{\textbf{precessziónak}} nevezzük.
                \item \underline{\textbf{Longitudinális}} hullámokban a közeg rezgéseinek kitérése párhuzamos a hullám terjedési irányával.
                \item \underline{\textbf{Izobár}} folyamatokban a gáz térfogata egyenesen arányos a hőmérséklettel.
                \item Az \underline{\textbf{ekvipartíció}} tételének értelmében a gázrészecskék egyes szabadsági fokaira jutó átlagos energia egyenlő.
